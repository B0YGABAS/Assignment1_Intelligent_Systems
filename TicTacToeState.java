...
public final class TicTacToeState {
	...
	/**
	 * The class constructor that creates the initial state of the game (player 'X'
	 * is the current/first player).
	 */
	...
	/**
	 * A private constructor used by this class to create a new state instance from
	 * the given int encoding.
	 * 
	 * @param state The int encoding of the state to be created.
	 */
	 ...
	 * current player.
	 * 
	 * @param x      The position of the move of the current player.
	 ...
	 * 
	 * @param x The board position to get the piece from.
	...
	/**
	 * This method determines whether the given player can make a valid move at the
	 * given board position.
	 * 
	 * @param x      The board position.
	 ...
	 * returns -1 if the game is in progress, 0 if the game ended in a draw, 1 if
	 * the game ended with player 'X' winning, and 2 if the game ended with player
	 * 'O' winning.
	 * 
	...
	public int getWinner() {
		...
		i = PIECE_NONE;
		if ((getPiece(0) != PIECE_NONE) && (getPiece(0) == getPiece(1)) && (getPiece(0) == getPiece(2))) {
			// first row
			i = getPiece(0);
		} else if ((getPiece(3) != PIECE_NONE) && (getPiece(3) == getPiece(4)) && (getPiece(3) == getPiece(5))) {
			// second row
			i = getPiece(3);
		} else if ((getPiece(6) != PIECE_NONE) && (getPiece(6) == getPiece(7)) && (getPiece(6) == getPiece(8))) {
			// third row
			i = getPiece(6);
		} else if ((getPiece(0) != PIECE_NONE) && (getPiece(0) == getPiece(3)) && (getPiece(0) == getPiece(6))) {
			// first column
			i = getPiece(0);
		} else if ((getPiece(1) != PIECE_NONE) && (getPiece(1) == getPiece(4)) && (getPiece(1) == getPiece(7))) {
			// second column
			i = getPiece(1);
		} else if ((getPiece(2) != PIECE_NONE) && (getPiece(2) == getPiece(5)) && (getPiece(2) == getPiece(8))) {
			// third column
			i = getPiece(2);
		} else if ((getPiece(0) != PIECE_NONE) && (getPiece(0) == getPiece(4)) && (getPiece(0) == getPiece(8))) {
			// diagonal 1
			i = getPiece(0);
		} else if ((getPiece(2) != PIECE_NONE) && (getPiece(2) == getPiece(4)) && (getPiece(2) == getPiece(6))) {
			// diagonal 2
			i = getPiece(2);
		}
